...
export default class SimpleMapView extends Component<any> {
  ...
  addElements(
    ...
    this.sendCommand("addElements",[elementType,target,size,testStatus]);
  }
  ...
  changeElementsVisible(elementType: number,visible: boolean){
    this.sendCommand("changeElementsVisible",[elementType,visible]);
  }
